...
They belong to this hook session; use the latest pair after a restart or a new
user turn following `finish`. Keep them in your own commands, never in messages
