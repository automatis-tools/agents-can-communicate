...
export const CLAUDE_DELIVERY_FALLBACK = Object.freeze({
  diagnostic: "Claude Code live delivery is not certified in this build; "
...
export function createClaudeCodeAdapter() {
  return defineAdapter({
    ...
    capabilities: {
      ...
      // nextTurn is the certified 2.1.233 hook projection. Live delivery
      // through the session inbox (src/inbox-delivery.mjs) is declared only
      // once a product capture of it passes.
