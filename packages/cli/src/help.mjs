...
const SUMMARY = Object.freeze({
  ...
  ack: "acknowledge receipt without accepting work or writing an answer",
...
const NOTES = Object.freeze({
  ...
  ack: ["An unanswered question/request requires reply; ack refuses without changing its receipt.",
    "Acknowledgement does not prevent a later reply."],
  reply: ["Returns the outgoing message/delivery plus the original acknowledged receipt.",
    "May follow ack or an earlier answer. Reuse a client-message-id only for the same send retry."],
  finish: ["Default status: partial. Records a handoff, releases claims, and closes this ACC session.",
    "Status describes the original goal; neither partial nor an acknowledged receipt means the peer accepted work."],
